...
const HELP_CHEER = [
  ...
  "봐, 수현아. 선배가 한 방 챙겨 줬지?",
  "이 구슬, 선배 특제야. 감사는 나중에.",
  "수현아 지금 이건 선배 실력이야. 잘 받아!",
  "후후, 수현아. 선배 찬스 나왔다.",
  "유수현, 이런 구슬은 아무나 못 줘.",
  "선배가 괜히 선배겠니 수현아.",
  "자 수현아, 선배가 판 깔아 줬어.",
  "이 정도면 수현이도 인정하지? 선배 굿.",
  "수현아 빚진 거다. 이 구슬 값 커.",
  "선배 도움 받고도 못 맞추면 진짜야, 수현아.",
  "유수현, 선배가 등판했다. 집중해.",
  "이봐 수현아, 선배가 구해줄 줄 알았지?",
  "수현아 오늘은 선배가 좀 잘해 준다.",
  "자랑 아닌데, 이 구슬은 선배만 줄 수 있어.",
  "수현아 고마운 줄 알아. 선배 찬스 한정이야.",
  "후후후 수현아, 선배 타이밍 보소.",
  "유수현, 선배가 안 도와줬으면 큰일 날 뻔.",
  "받아 수현아. 이건 선배 간판 구슬이야.",
  "수현아 선배 도움은 공짜가 아니야. 팬이야.",
  "봐봐 수현아, 선배면 이 정도는 기본이지.",
  "유수현, 선배가 구원투수다. 감사 인사 준비해.",
];
